...
var SettingsService = class extends BaseService {
  ...
  generateAppleClientSecret(e2, t2, s2, i2, n2, r) {
    return __async(this, null, function* () {
...
var AdminService = class _AdminService extends CrudService {
  ...
  authWithPassword(e2, t2, s2, i2) {
    return __async(this, null, function* () {
      ...
      let o = yield this.client.send(this.baseCrudPath + "/auth-with-password", n2);
...
var RecordService = class _RecordService extends CrudService {
  ...
  authWithOAuth2Code(e2, t2, s2, i2, n2, r, o) {
    return __async(this, null, function* () {
  ...
  authWithOAuth2(...e2) {
    ...
    return r && (n2.requestKey = r), this.listAuthMethods(n2).then((e3) => {
      ...
      return a && (a.signal.onabort = () => {
        cleanup();
      }), new Promise((e4, r2) => __async(this, null, function* () {
        try {
          yield i2.subscribe("@oauth2", (s3) => __async(this, null, function* () {
            ...
            try {
              ...
              const r3 = yield this.authWithOAuth2Code(n3.name, s3.code, n3.codeVerifier, o, t2.createData, i3);
              e4(r3);
            } catch (e5) {
